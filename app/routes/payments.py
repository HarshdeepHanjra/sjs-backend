        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="https://sjs-frontend-delta.vercel.app/my-courses" class="button">📚 Access Your Courses</a>
                </div>
                
                <p>Thank you for choosing SJS Global Tech Academy!</p>
                <p>Best regards,<br>SJS Global Tech Academy Team</p>
            </div>
        </div>
    </body>
    </html>
