...
def create_app():
    ...
    # Allowed origins list (ADDED sjsglobaltech.com)
    ALLOWED_ORIGINS = [
    ...
    # Manual OPTIONS handler for all routes (backup) - FIXED ✅
    @app.before_request
    def handle_preflight():
        if request.method == "OPTIONS":
            response = app.make_default_options_response()
    ...
    print(f"✅ CORS configured successfully! Allowed origins: {ALLOWED_ORIGINS}")
