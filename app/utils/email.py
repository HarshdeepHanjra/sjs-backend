...
def send_email_via_brevo(to_email, to_name, subject, html_content, text_content=None):
    ...
    try:
        api_key = os.getenv('BREVO_API_KEY')
        sender_email = os.getenv('BREVO_SENDER_EMAIL', 'noreply@sjsglobaltech.com')  # ✅ Changed
        sender_name = os.getenv('BREVO_SENDER_NAME', 'SJS Global Tech')  # ✅ Changed
...
def send_password_reset_email(user, reset_token):
    ...
    """
    try:
        frontend_url = os.getenv('FRONTEND_URL', 'https://sjsglobaltech.com')  # ✅ Changed
        reset_url = f"{frontend_url}/reset-password?token={reset_token}"
        
        subject = "Password Reset Request - SJS Global Tech"  # ✅ Changed
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1 style="margin: 0;">SJS Global Tech</h1>  <!-- ✅ Changed -->
                    <p style="margin: 10px 0 0; opacity: 0.9;">Password Reset Request</p>
                </div>
                <div class="content">
                    <p>Dear <strong>{user.name}</strong>,</p>
                    <p>We received a request to reset the password for your SJS Global Tech account.</p>  <!-- ✅ Changed -->
                    <p>Click the button below to create a new password:</p>
                    <p style="text-align: center;">
                        <a href="{reset_url}" class="button" style="color: white;">Reset Password</a>
                    </p>
        ...
        # Plain text version
        text_content = f"""
        SJS Global Tech - Password Reset Request  # ✅ Changed
        
        Dear {user.name},
        
        We received a request to reset the password for your SJS Global Tech account.  # ✅ Changed
        ...
        ---
        SJS Global Tech  # ✅ Changed
        https://sjsglobaltech.com  # ✅ Changed
        """
...
def send_welcome_email(user):
    ...
    try:
        frontend_url = os.getenv('FRONTEND_URL', 'https://sjsglobaltech.com')  # ✅ Changed
        subject = "Welcome to SJS Global Tech!"  # ✅ Changed
        ...
        <body>
            <div class="container">
                <div class="header">
                    <h1 style="margin: 0;">Welcome to SJS Global Tech! 🎉</h1>  <!-- ✅ Changed -->
                </div>
                <div class="content">
                    <p>Dear <strong>{user.name}</strong>,</p>
                    <p>Thank you for registering with SJS Global Tech. We're excited to have you on board!</p>  <!-- ✅ Changed -->
        ...
        text_content = f"""
        Welcome to SJS Global Tech!  # ✅ Changed
        
        Dear {user.name},
        
        Thank you for registering with SJS Global Tech. We're excited to have you on board!  # ✅ Changed
    ...
    try:
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Dear <strong>{user.name}</strong>,</p>
                    <p>You have successfully enrolled in <strong>{course_name}</strong> at SJS Global Tech!</p>  <!-- ✅ Changed -->
                    <p><strong>Order ID:</strong> {order_id}</p>
                    <p>Start learning now and take your skills to the next level.</p>
                    <p style="text-align: center;">
                        <a href="{frontend_url}/my-courses" class="button" style="color: white;">Go to My Courses →</a>
